	...
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<!-- Form START -->
				<form action="{{ route('ad.profiled',$admins) }}" method="POST" enctype="multipart/form-data">
					@csrf
					@method('PUT')
							...
							<div class="bg-secondary-soft px-4 py-5 rounded">
								<div class="row g-3">
									...
									<div class="col-md-6">
										...
										<input type="text" class="form-control" placeholder="" name="name_admin"
											value="{{ $admins->name_admin }}">
									</div>
									<!-- Phone -->
									<div class="col-md-6">
