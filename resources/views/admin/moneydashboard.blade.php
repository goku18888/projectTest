         ...
         <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <p class="title_thongke">Thong Ke Truy Cap Tong Tien</p>
                        <table class="table table-dark">
                            <thead>
                              <tr>
                                <th scope="col">Tong 7 ngay trc</th>
                                <th scope="col">Tong thang truoc</th>
                                <th scope="col">Tong thang nay</th>
                                <th scope="col">Tong 365 ngay</th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr>
                    ...
                    <div class="row">
                        <p class="title_thongke">Thống Kê Truy Cập Tiền Lãi Hoặc Lỗ</p>
                        <table class="table table-dark">
                            <thead>
                                <tr>
                                    <th scope="col">Năm</th>
                                    <th scope="col">Tổng Tiền Nhập Hàng</th>
                                    <th scope="col">Lãi(+) Hoặc Lỗ(-)</th>
                                </tr>
                            </thead>
                            <tbody>
...
$(document).ready(function(){
    ...
    $('.dashboard-filter').change(function(){
        ...
        var _token=$('input[name="_token"]').val();
        $.ajax({
            url:"{{ url('/admin/dashboard-filter-m') }}",
            method:"POST",
            dataType:'JSON',
    ...
    $('#btn-dashboard-filter').click(function(){
        ...
        $.ajax({
            url:"{{ url('/admin/filter-by-date-m') }}",
            method:"POST",
            dataType:'JSON',
