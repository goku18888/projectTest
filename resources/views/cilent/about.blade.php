...
<html>
    ...
    <body>
        ...
        <header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(/storage/img/cilent/slide.jpg);">
            ...
            <div class="container">
                <div class="about-content">
                    <div class="row animate-box">
                        ...
                        <div class="col-md-6">
                            <img class="img-responsive" src="/storage/img/cilent/iphoneXS.jpg" alt="about">
                        </div>
                    </div>
                </div>
                <div class="row animate-box">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 animate-box" data-animate-effect="fadeIn">
                        <div class="fh5co-staff">
                            <img src="/storage/img/cilent/person1.jpg" alt="Free HTML5 Templates by gettemplates.co">
                            <h3>Jean Smith</h3>
