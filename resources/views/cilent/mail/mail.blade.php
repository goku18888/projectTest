...
<body>
    <div class="container" style="background: #222;border-radius: 12px;padding: 15px;">
        <div class="col-md-12">
            <p style="text-align: center;color: #fff;">Đây Là Email Tự Động,Làm Ơn Không Trả Lời Mail Này !!!</p>
            <div class="row" style="background: cadetblue;padding: 15px;">
                ...
                <div class="col-md-6 logo" style="color: #fff">
                    <p>Chào Bạn <strong style="color: #000;text-decoration: underline;">{{$shipping_array['name_customer']}}</strong></p>
                </div>
                <div class="col-md-12">
                    <p style="color: #fff;font-size: 17px;">Bạn Hoặc Ai Đó Đã Đăng Ký Đơn Hàng Như Sau:</p>
                    ...
                    <p>Email:
                        @if ($shipping_array['shipping_email']=='null')
                            Không Điền
                        @else
